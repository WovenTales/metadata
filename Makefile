#############################################################################
# Makefile for building: bin/metadata
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  metadata.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile metadata.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = metadata1.0.0
DISTDIR = /data/sam/docs/school/cis-433/obj/metadata1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		metadata.pro include/imagepanel.hxx src/imagepanel.cxx \
		src/main.cxx
...
Makefile: metadata.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/imagepanel.hxx $(DISTDIR)/
	$(COPY_FILE) --parents src/imagepanel.cxx src/main.cxx $(DISTDIR)/
